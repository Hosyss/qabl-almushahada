...
9. **دليل قابل للتتبع**: كل سبب في القرار يحمل معرّفات الوقائع التي فعّلته.
10. **سجل تدقيق لا يُعدّل**: تغييرات سير المراجعة تُضاف كأحداث جديدة بدل محو التاريخ.
11. **بلاغات وتصحيح**: اختلاف النسخة أو الواقعة يفتح تحقيقًا مرتبطًا بحزمة المراجعة.
...
أي فشل في هوية النسخة، التغطية، عدد المراجعين المطلوب حسب المخاطر، الاستقلال، الاتساق، أو الاعتماد يعيد:
