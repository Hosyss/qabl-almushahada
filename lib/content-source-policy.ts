...
export const CONTENT_SOURCE_POLICIES = {
  ...
  wikipedia: {
    ...
    verifiedOn: "2026-08-13",
    notesAr:
      "نستخدم نص Wikipedia كمدخل دليل مرخص لا كمراجعة جاهزة: نحفظ URL وrevision والرخصة والعزو وhash، ولا ننشر المقالة أو ترجمة مطولة منها. الوقائع والصياغة النهائية تُنتج بمنهج قبل المشاهدة، وأي نص مقتبس/مقتبس منه يجب أن يلتزم CC BY-SA والعزو وShareAlike. طلبات API يجب أن تكون محدودة وبـUser-Agent واضح وتحترم throttling/maxlag.",
  },
  wikimediaCommons: {
