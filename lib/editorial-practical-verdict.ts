...
export const EDITORIAL_PRACTICAL_OUTCOME_LABELS_AR = {
  watch: "يمكن مشاهدته وفق حدود أسرتك",
...
export function buildPracticalEditorialVerdictSummaryAr(
  ...
  if (verdict.outcome === "watch") {
    return "كل ما يمكن أن يؤثر في الحكم الحالي يقع داخل حدود يمكن إثباتها من غير اختراع شدة؛ لذلك يمكن مشاهدته وفق إعدادات الأسرة الحالية.";
  }
